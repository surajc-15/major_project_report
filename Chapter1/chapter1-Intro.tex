...
%========================================================
Traditional anti-money laundering systems depend on rules, thresholds, and human investigations. While these methods are capable of identifying suspicious transactions, they miss the relational information that happens through coordinated money laundering acts. Importers, exporters, shell companies, offshore companies, logistic firms and financial intermediaries are core TBML networks. Multilayer schemes conducted in different jurisdictions complicate the identification of suspicious patterns through conventional means. In addition, most of the existing ML methods are limited since they treat the transactions as independent events. This results in missing out on hidden structures and relational patterns in financial networks.

Due to this,  traditional systems generating high false positives, thus delay further investigation and overall detection rate. The privacy rules in the regulations state that entities cannot share their clients’ sensitive transactional data, which means centralized detection is not possible. Transactions of various kinds between different financial entities results in high false positive detection. It shows the importance of analytical frameworks which models the complex distributed financial ecosystem and detect sophisticated TBML in a scalable and privacy-pres.
...
According to a recent paper, we find that AML techniques are slowly departing from traditional heuristic rule-based methods to graph-based and machine learning techniques. In addition, we pinpoint current AML research challenges such as heterogeneous graph modelling, real-time modelling of changing fraudulent activities, privacy-preserving. Further, existing methods often target either centralized banking or cryptocurrency datasets. Further, they do not have any capability to reflect the complex trading relations in TBML. Additionally, they overlook the financial institution privacy issue and the scalability issue in the distributed heterogeneous trade-finance network.  Ultimately, these limitations motivate us to work towards a unified framework, graphFed, which seamlessly integrates heterogeneous graph learning, federated intelligence and real-time detect ability.
