...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Federated Heterogeneous Graph Neural Networks for TBML Detection}
\newcommand{\projecttitle}{Federated Heterogeneous Graph Neural Networks for TBML Detection}
\subCode{CS481P}
...
%% Pannel Members %%
\panelMemberNameA{Dr. Nagaraj G. S}
...
\begin{document}
	...
	\begin{spacing}{1.5}
		...
		%Chapter 3
		\input{./Chapter3/chapter3-softwarespecifications}
		
		%Chapter 4
		\input{./Chapter4/chapter4-highlevel-design}
		
		%Chapter 5
		\input{./Chapter5/chapter5-detaileddesign}
		
		%Chapter 6
		\input{./Chapter6/chapter6-Implmentation}

		%Chapter 7
		\input{./Chapter7/chapter7-testing}

		%Chapter 8
		\input{./Chapter8/chapter8-results}

		%Chapter 9
		\input{./Chapter9/chapter9-conclution}

		
		%% Uncomment the following 2 commands to add Appendix chapters
		\appendix
		\input{./Appendix/ApndxA}%Appendix Chapter 1
		\input{./Appendix/ApndxB}%Appendix Chapter 2
		\input{./Appendix/ApndxC}%Appendix Chapter 3
